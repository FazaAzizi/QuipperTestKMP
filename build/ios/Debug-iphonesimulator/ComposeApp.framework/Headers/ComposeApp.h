...
@required
- (ComposeAppKtor_client_coreHttpClient *)getHttpClientEngineForMultipartData:(BOOL)forMultipartData __attribute__((swift_name("getHttpClientEngine(forMultipartData:)")));
- (NSString *)getRequestHash __attribute__((swift_name("getRequestHash()")));
- (BOOL)isDebugMode __attribute__((swift_name("isDebugMode()")));
...
@protocol ComposeAppKtor_client_loggingLogger
@required
...
@interface ComposeAppCustomLogger : ComposeAppBase <ComposeAppKtor_client_loggingLogger>
- (instancetype)initWithLog:(ComposeAppKermitLogger *)log __attribute__((swift_name("init(log:)"))) __attribute__((objc_designated_initializer));
- (void)logMessage:(NSString *)message __attribute__((swift_name("log(message:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiRoutes")))
@interface ComposeAppApiRoutes : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)apiRoutes __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppApiRoutes *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *COURSELIST __attribute__((swift_name("COURSELIST")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiStatus")))
@interface ComposeAppApiStatus : ComposeAppKotlinEnum<ComposeAppApiStatus *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) ComposeAppApiStatus *success __attribute__((swift_name("success")));
@property (class, readonly) ComposeAppApiStatus *error __attribute__((swift_name("error")));
@property (class, readonly) ComposeAppApiStatus *loading __attribute__((swift_name("loading")));
+ (ComposeAppKotlinArray<ComposeAppApiStatus *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<ComposeAppApiStatus *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkRepository")))
@interface ComposeAppNetworkRepository : ComposeAppBase
...
- (id<ComposeAppKotlinx_coroutines_coreFlow>)course __attribute__((swift_name("course()")));
@end

__attribute__((swift_name("NetworkResult")))
@interface ComposeAppNetworkResult<__covariant T> : ComposeAppBase
@property (readonly) T _Nullable data __attribute__((swift_name("data")));
@property (readonly) NSString * _Nullable message __attribute__((swift_name("message")));
@property (readonly) ComposeAppApiStatus *status __attribute__((swift_name("status")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkResultError")))
@interface ComposeAppNetworkResultError<__covariant T> : ComposeAppNetworkResult<T>
- (instancetype)initWith_data:(T _Nullable)_data exception:(NSString *)exception __attribute__((swift_name("init(_data:exception:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppNetworkResultError<T> *)doCopy_data:(T _Nullable)_data exception:(NSString *)exception __attribute__((swift_name("doCopy(_data:exception:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface ComposeAppNetworkResultLoading<__covariant T> : ComposeAppNetworkResult<T>
...
- (ComposeAppNetworkResultLoading<T> *)doCopyIsLoading:(BOOL)isLoading __attribute__((swift_name("doCopy(isLoading:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface ComposeAppNetworkResultSuccess<__covariant T> : ComposeAppNetworkResult<T>
- (instancetype)initWith_data:(T _Nullable)_data __attribute__((swift_name("init(_data:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppNetworkResultSuccess<T> *)doCopy_data:(T _Nullable)_data __attribute__((swift_name("doCopy(_data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) T _Nullable _data __attribute__((swift_name("_data")));
...
@interface ComposeAppMvvm_coreViewModel : ComposeAppBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)onCleared __attribute__((swift_name("onCleared()")));
@property (readonly) id<ComposeAppKotlinx_coroutines_coreCoroutineScope> viewModelScope __attribute__((swift_name("viewModelScope")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CourseListViewModel")))
@interface ComposeAppCourseListViewModel : ComposeAppMvvm_coreViewModel
- (instancetype)initWithNetworkRepository:(ComposeAppNetworkRepository *)networkRepository __attribute__((swift_name("init(networkRepository:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
*/
- (void)courseWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("course(completionHandler:)")));
@property (readonly) id<ComposeAppKotlinx_coroutines_coreStateFlow> courseListViewState __attribute__((swift_name("courseListViewState")));
@end

__attribute__((swift_name("CourseListViewModel.CourseListScreenState")))
@interface ComposeAppCourseListViewModelCourseListScreenState : ComposeAppBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CourseListViewModel.CourseListScreenStateError")))
@interface ComposeAppCourseListViewModelCourseListScreenStateError : ComposeAppCourseListViewModelCourseListScreenState
...
- (ComposeAppCourseListViewModelCourseListScreenStateError *)doCopyErrorMessage:(NSString *)errorMessage __attribute__((swift_name("doCopy(errorMessage:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *errorMessage __attribute__((swift_name("errorMessage")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CourseListViewModel.CourseListScreenStateLoading")))
@interface ComposeAppCourseListViewModelCourseListScreenStateLoading : ComposeAppCourseListViewModelCourseListScreenState
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)loading __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppCourseListViewModelCourseListScreenStateLoading *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CourseListViewModel.CourseListScreenStateSuccess")))
@interface ComposeAppCourseListViewModelCourseListScreenStateSuccess : ComposeAppCourseListViewModelCourseListScreenState
- (instancetype)initWithResponseData:(NSArray<ComposeAppCourseEntity *> *)responseData __attribute__((swift_name("init(responseData:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppCourseListViewModelCourseListScreenStateSuccess *)doCopyResponseData:(NSArray<ComposeAppCourseEntity *> *)responseData __attribute__((swift_name("doCopy(responseData:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<ComposeAppCourseEntity *> *responseData __attribute__((swift_name("responseData")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CourseDetailScreenKt")))
@interface ComposeAppCourseDetailScreenKt : ComposeAppBase
+ (NSString *)formatDurationDurationMs:(int64_t)durationMs __attribute__((swift_name("formatDuration(durationMs:)")));
@end
...
+ (NSString *)sha256Hmac:(NSString *)receiver algorithm:(uint32_t)algorithm key:(NSString *)key __attribute__((swift_name("sha256Hmac(_:algorithm:key:)")));
+ (NSString *)stringFromResultResult:(id)result length:(int32_t)length __attribute__((swift_name("stringFromResult(result:length:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteLibKt")))
@interface ComposeAppRemoteLibKt : ComposeAppBase

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
+ (ComposeAppKtor_client_coreHttpClient *)setupHttpClientJson:(ComposeAppKotlinx_serialization_jsonJson *)json baseUrl:(NSString *)baseUrl urlProtocol:(ComposeAppKtor_httpURLProtocol *)urlProtocol kermitLogger:(ComposeAppKermitLogger *)kermitLogger isDebugMode:(BOOL)isDebugMode httpClientProvider:(ComposeAppKtor_client_coreHttpClient *)httpClientProvider __attribute__((swift_name("setupHttpClient(json:baseUrl:urlProtocol:kermitLogger:isDebugMode:httpClientProvider:)")));

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
+ (ComposeAppKotlinx_serialization_jsonJson *)setupJson __attribute__((swift_name("setupJson()")));
+ (ComposeAppKermitLogger *)setupKermit __attribute__((swift_name("setupKermit()")));
@end
...
@interface ComposeAppRepositoryModuleKt : ComposeAppBase
@property (class, readonly) ComposeAppKoin_coreModule *networkModule __attribute__((swift_name("networkModule")));
@end
...
@interface ComposeAppViewModelModuleKt : ComposeAppBase
@property (class, readonly) ComposeAppKoin_coreModule *viewModelModule __attribute__((swift_name("viewModelModule")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ToResultFlowKt")))
@interface ComposeAppToResultFlowKt : ComposeAppBase
+ (id<ComposeAppKotlinx_coroutines_coreFlow>)toResultFlowCall:(id<ComposeAppKotlinSuspendFunction0>)call __attribute__((swift_name("toResultFlow(call:)")));
@end
...
- (void)aMessage:(NSString *)message throwable:(ComposeAppKotlinThrowable *)throwable __attribute__((swift_name("a(message:throwable:)")));
- (void)aThrowable:(ComposeAppKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("a(throwable:message:)")));
...
- (void)dMessage:(NSString *)message throwable:(ComposeAppKotlinThrowable *)throwable __attribute__((swift_name("d(message:throwable:)")));
- (void)dThrowable:(ComposeAppKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("d(throwable:message:)")));
...
- (void)eMessage:(NSString *)message throwable:(ComposeAppKotlinThrowable *)throwable __attribute__((swift_name("e(message:throwable:)")));
- (void)eThrowable:(ComposeAppKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("e(throwable:message:)")));
...
- (void)iMessage:(NSString *)message throwable:(ComposeAppKotlinThrowable *)throwable __attribute__((swift_name("i(message:throwable:)")));
- (void)iThrowable:(ComposeAppKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("i(throwable:message:)")));
- (void)logSeverity:(ComposeAppKermitSeverity *)severity tag:(NSString *)tag throwable:(ComposeAppKotlinThrowable * _Nullable)throwable message:(NSString *)message __attribute__((swift_name("log(severity:tag:throwable:message:)")));
...
- (void)vMessage:(NSString *)message throwable:(ComposeAppKotlinThrowable *)throwable __attribute__((swift_name("v(message:throwable:)")));
- (void)vThrowable:(ComposeAppKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("v(throwable:message:)")));
...
- (void)wMessage:(NSString *)message throwable:(ComposeAppKotlinThrowable *)throwable __attribute__((swift_name("w(message:throwable:)")));
- (void)wThrowable:(ComposeAppKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("w(throwable:message:)")));
- (ComposeAppKermitLogger *)withTagTag:(NSString *)tag __attribute__((swift_name("withTag(tag:)")));
@property (readonly) id<ComposeAppKermitLoggerConfig> config __attribute__((swift_name("config")));
...
@protocol ComposeAppKotlinx_serialization_coreSerialFormat
@required
...
@protocol ComposeAppKotlinx_serialization_coreStringFormat <ComposeAppKotlinx_serialization_coreSerialFormat>
@required
- (id _Nullable)decodeFromStringDeserializer:(id<ComposeAppKotlinx_serialization_coreDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("decodeFromString(deserializer:string:)")));
- (NSString *)encodeToStringSerializer:(id<ComposeAppKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToString(serializer:value:)")));
@end

__attribute__((swift_name("Kotlinx_serialization_jsonJson")))
@interface ComposeAppKotlinx_serialization_jsonJson : ComposeAppBase <ComposeAppKotlinx_serialization_coreStringFormat>
@property (class, readonly, getter=companion) ComposeAppKotlinx_serialization_jsonJsonDefault *companion __attribute__((swift_name("companion")));
- (id _Nullable)decodeFromJsonElementDeserializer:(id<ComposeAppKotlinx_serialization_coreDeserializationStrategy>)deserializer element:(ComposeAppKotlinx_serialization_jsonJsonElement *)element __attribute__((swift_name("decodeFromJsonElement(deserializer:element:)")));
- (id _Nullable)decodeFromStringString:(NSString *)string __attribute__((swift_name("decodeFromString(string:)")));
- (id _Nullable)decodeFromStringDeserializer:(id<ComposeAppKotlinx_serialization_coreDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("decodeFromString(deserializer:string:)")));
- (ComposeAppKotlinx_serialization_jsonJsonElement *)encodeToJsonElementSerializer:(id<ComposeAppKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToJsonElement(serializer:value:)")));
- (NSString *)encodeToStringSerializer:(id<ComposeAppKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeToString(serializer:value:)")));
- (ComposeAppKotlinx_serialization_jsonJsonElement *)parseToJsonElementString:(NSString *)string __attribute__((swift_name("parseToJsonElement(string:)")));
@property (readonly) ComposeAppKotlinx_serialization_jsonJsonConfiguration *configuration __attribute__((swift_name("configuration")));
@property (readonly) ComposeAppKotlinx_serialization_coreSerializersModule *serializersModule __attribute__((swift_name("serializersModule")));
@end
...
@protocol ComposeAppKotlinSuspendFunction0 <ComposeAppKotlinFunction>
@required
...
- (id)getKey__:(ComposeAppKtor_utilsAttributeKey<id> *)key __attribute__((swift_name("get(key__:)")));
...
@interface ComposeAppKotlinx_serialization_jsonJsonDefault : ComposeAppKotlinx_serialization_jsonJson
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)default_ __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppKotlinx_serialization_jsonJsonDefault *shared __attribute__((swift_name("shared")));
@end
...
@interface ComposeAppKotlinx_serialization_jsonJsonElement : ComposeAppBase
@property (class, readonly, getter=companion) ComposeAppKotlinx_serialization_jsonJsonElementCompanion *companion __attribute__((swift_name("companion")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_jsonJsonConfiguration")))
@interface ComposeAppKotlinx_serialization_jsonJsonConfiguration : ComposeAppBase
- (NSString *)description __attribute__((swift_name("description()")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
@property (readonly) id<ComposeAppKotlinx_serialization_jsonJsonNamingStrategy> _Nullable namingStrategy __attribute__((swift_name("namingStrategy")));
...
@property (readonly) ComposeAppStately_concurrencyThreadLocalRef<NSMutableArray<ComposeAppKoin_coreParametersHolder *> *> *_parameterStackLocal __attribute__((swift_name("_parameterStackLocal")));
...
- (T _Nullable)createContext:(ComposeAppKoin_coreInstanceContext *)context __attribute__((swift_name("create(context:)")));
- (void)dropScope:(ComposeAppKoin_coreScope * _Nullable)scope __attribute__((swift_name("drop(scope:)")));
- (void)dropAll __attribute__((swift_name("dropAll()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (T _Nullable)getContext:(ComposeAppKoin_coreInstanceContext *)context __attribute__((swift_name("get(context:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (BOOL)isCreatedContext:(ComposeAppKoin_coreInstanceContext * _Nullable)context __attribute__((swift_name("isCreated(context:)")));
...
@interface ComposeAppKotlinx_serialization_jsonJsonElementCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppKotlinx_serialization_jsonJsonElementCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@protocol ComposeAppKotlinx_serialization_jsonJsonNamingStrategy
@required
- (NSString *)serialNameForJsonDescriptor:(id<ComposeAppKotlinx_serialization_coreSerialDescriptor>)descriptor elementIndex:(int32_t)elementIndex serialName:(NSString *)serialName __attribute__((swift_name("serialNameForJson(descriptor:elementIndex:serialName:)")));
@end
...
@interface ComposeAppStately_concurrencyThreadLocalRef<T> : ComposeAppBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
- (ComposeAppKoin_coreBeanDefinition<T> *)doCopyScopeQualifier:(id<ComposeAppKoin_coreQualifier>)scopeQualifier primaryType:(id<ComposeAppKotlinKClass>)primaryType qualifier:(id<ComposeAppKoin_coreQualifier> _Nullable)qualifier definition:(T _Nullable (^)(ComposeAppKoin_coreScope *, ComposeAppKoin_coreParametersHolder *))definition kind:(ComposeAppKoin_coreKind *)kind secondaryTypes:(NSArray<id<ComposeAppKotlinKClass>> *)secondaryTypes __attribute__((swift_name("doCopy(scopeQualifier:primaryType:qualifier:definition:kind:secondaryTypes:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
...
@interface ComposeAppKoin_coreInstanceContext : ComposeAppBase
- (instancetype)initWithLogger:(ComposeAppKoin_coreLogger *)logger scope:(ComposeAppKoin_coreScope *)scope parameters:(ComposeAppKoin_coreParametersHolder * _Nullable)parameters __attribute__((swift_name("init(logger:scope:parameters:)"))) __attribute__((objc_designated_initializer));
@property (readonly) ComposeAppKoin_coreLogger *logger __attribute__((swift_name("logger")));
...
@property ComposeAppKoin_coreKoin *koin __attribute__((swift_name("koin")));
@end
