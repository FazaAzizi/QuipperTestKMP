...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final PermissionsLibraryAccessors laccForPermissionsLibraryAccessors = new PermissionsLibraryAccessors(owner);
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for imageloader (io.github.qdsfdhvh:image-loader)
         * This dependency was declared in catalog libs.versions.toml
         */
         ...
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKermit() {
            return create("kermit");
    }
         ...
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getStately() {
            return create("stately");
    }
    ...
    /**
     * Returns the group of libraries at permissions
     */
    public PermissionsLibraryAccessors getPermissions() {
        return laccForPermissionsLibraryAccessors;
    }
    ...
    public static class PermissionsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public PermissionsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for permissions (dev.icerock.moko:permissions)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
            ...
            /**
             * Creates a dependency provider for compose (dev.icerock.moko:permissions-compose)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() {
                return create("permissions.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final KmpVersionAccessors vaccForKmpVersionAccessors = new KmpVersionAccessors(providers, config);
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: buildkonfig (0.15.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: decompose (2.2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: kermit (1.1.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: mvvmCore (0.16.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMvvmCore() { return getVersion("mvvmCore"); }

            /**
             * Returns the version associated to this alias: permissions (0.17.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: touchlab (2.0.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getTouchlab() { return getVersion("touchlab"); }
        ...
        /**
         * Returns the group of versions at versions.kmp
         */
        public KmpVersionAccessors getKmp() {
            return vaccForKmpVersionAccessors;
        }
    ...
    public static class ImageVersionAccessors extends VersionFactory  {
        ...
        public ImageVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: image.loader (1.7.8)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KmpVersionAccessors extends VersionFactory  {

        private final KmpNativeVersionAccessors vaccForKmpNativeVersionAccessors = new KmpNativeVersionAccessors(providers, config);
        public KmpVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.kmp.native
         */
        public KmpNativeVersionAccessors getNative() {
            return vaccForKmpNativeVersionAccessors;
        }

    }

    public static class KmpNativeVersionAccessors extends VersionFactory  {

        public KmpNativeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: kmp.native.coroutines (0.13.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCoroutines() { return getVersion("kmp.native.coroutines"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for kmpNativeCoroutines to the plugin id 'com.rickclephas.kmp.nativecoroutines'
             * This plugin was declared in catalog libs.versions.toml
             */
